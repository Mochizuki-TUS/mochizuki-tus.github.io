/* 発展教材の閲覧ガード．
   5冊（マテリアル計算科学・固体物理学・密度汎関数理論・線形応答理論・素粒子物理学）は
   どれも同じパスワードで開くので，保存キーも共通の1つに統一してある．
   education.html で一度パスワードを確認すれば，このタブでは5冊すべてが開く．
   5つの *_Textbook/assets/access-guard.js は，
...
(function () {
  ...
  if (!allowed) {
    ...
    window.location.replace('../education.html#epp-textbook');
  }
})();
